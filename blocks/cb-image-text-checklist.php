	...
	<div class="container">
		<div class="row gy-5 align-items-center">
			...
			<div class="col-lg-6 <?= 'left' === $image_position ? 'order-lg-first' : ''; ?>">
				<div class="cb-image-text-checklist__media cb-image-text-checklist__media--<?= esc_attr( $image_style ); ?>">
					<?php
					if ( 'layered' === $image_style ) {
						?>
					...
					if ( 'layered' === $image_style && ! empty( $image_2['ID'] ) ) {
						?>
					...
					if ( 'layered' === $image_style && ! empty( $image_3['ID'] ) ) {
						?>
